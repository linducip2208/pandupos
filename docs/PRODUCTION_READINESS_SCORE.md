...
| Future addon parity | 68% (OPEN) | Accounting, CRM, Manufacturing, Repair, Project, Asset, HRM, Payroll and Ecommerce modules implemented with full evidence (tests + docs); 7 addon gates (WooCommerce, HMS, Gym, AI, Field Force, ZATCA, Cheque) remain unverified and score only on real implementation |
