...
| Future addon parity | 84% (OPEN) | Accounting, CRM, Manufacturing, Repair, Project, Asset, HRM, Payroll, Ecommerce, WooCommerce, HMS and Gym modules implemented with full evidence (tests + docs); 4 addon gates (AI, Field Force, ZATCA, Cheque) remain unverified and score only on real implementation |
