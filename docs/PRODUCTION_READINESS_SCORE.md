...
| Future addon parity | 88% (OPEN) | Accounting, CRM, Manufacturing, Repair, Project, Asset, HRM, Payroll, Ecommerce, WooCommerce, HMS, Gym and AI modules implemented with full evidence (tests + docs); 3 addon gates (Field Force, ZATCA, Cheque) remain unverified and score only on real implementation |
