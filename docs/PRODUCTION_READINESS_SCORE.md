...
|---|---:|---|
| Core parity | 47% | Product, units, barcode, pricing, bundle, batch/expiry/FEFO, rack/bin, reservation, serial lifecycle, WAC, stock adjustment, stock count, reconciliation and transfer have independently verified evidence; purchasing, sales/POS and reporting remain incomplete |
