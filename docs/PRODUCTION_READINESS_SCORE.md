...
| Future addon parity | 80% (OPEN) | Accounting, CRM, Manufacturing, Repair, Project, Asset, HRM, Payroll, Ecommerce, WooCommerce and HMS modules implemented with full evidence (tests + docs); 5 addon gates (Gym, AI, Field Force, ZATCA, Cheque) remain unverified and score only on real implementation |
