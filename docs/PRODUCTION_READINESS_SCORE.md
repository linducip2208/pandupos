...
| Future addon parity | 100% (OPEN) | All 16 addon modules implemented with full evidence (tests + docs): Accounting, CRM, Manufacturing, Repair, Project, Asset, HRM, Payroll, Ecommerce, WooCommerce, HMS, Gym, AI, Field Force, ZATCA, Cheque. Restaurant is additionally available as a tenant-optional business feature (default OFF, `docs/RESTAURANT.md`) — unscored by design, no ledger weights changed |
