...
| Future addon parity | 28% (OPEN) | Accounting, CRM and Manufacturing modules implemented with full evidence (`AccountingTest`, `CrmTest`, `MrpTest`, `docs/ACCOUNTING.md`, `docs/CRM.md`, `docs/MRP.md`); 13 addon gates (Repair, Project, Asset, HRM, Payroll, Ecommerce, WooCommerce, HMS, Gym, AI, Field Force, ZATCA, Cheque) remain unverified and score only on real implementation |
