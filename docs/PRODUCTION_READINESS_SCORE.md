...
|---|---:|---|
| Core parity | 30% | Product, units, barcode, pricing, bundle, WAC, and complete stock-adjustment and stock-count gates have independently verified evidence; other advanced inventory, purchasing, sales/POS and reporting remain incomplete |
