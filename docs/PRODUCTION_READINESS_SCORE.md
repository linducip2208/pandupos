...
|---|---:|---|
| Core parity | 34% | Product, units, barcode, pricing, bundle, WAC, stock adjustment, stock count, reconciliation and transfer have independently verified evidence; other advanced inventory, purchasing, sales/POS and reporting remain incomplete |
