...
|---|---:|---|
| Core parity | 31% | Product, units, barcode, pricing, bundle, WAC, stock adjustment, stock count and reconciliation have independently verified evidence; other advanced inventory, purchasing, sales/POS and reporting remain incomplete |
