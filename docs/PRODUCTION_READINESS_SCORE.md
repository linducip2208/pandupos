...
| Future addon parity | 74% (OPEN) | Accounting, CRM, Manufacturing, Repair, Project, Asset, HRM, Payroll, Ecommerce and WooCommerce modules implemented with full evidence (tests + docs); 6 addon gates (HMS, Gym, AI, Field Force, ZATCA, Cheque) remain unverified and score only on real implementation |
