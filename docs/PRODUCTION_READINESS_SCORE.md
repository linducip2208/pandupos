...
| Future addon parity | 12% (OPEN) | Accounting module implemented with full evidence (`AccountingTest`, `docs/ACCOUNTING.md`); 15 addon gates (CRM, MRP, Repair, Project, Asset, HRM, Payroll, Ecommerce, WooCommerce, HMS, Gym, AI, Field Force, ZATCA, Cheque) remain unverified and score only on real implementation |
