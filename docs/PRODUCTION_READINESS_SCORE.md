...
|---|---:|---|
| Core parity | 30% | Product/conversion/pricing/barcode/bundle foundations improved; major workflows missing |
...
| Test readiness | 37% | New catalog/inventory workflows proven; suite still lacks most final-matrix items |
