...
| Future addon parity | 20% (OPEN) | Accounting and CRM modules implemented with full evidence (`AccountingTest`, `CrmTest`, `docs/ACCOUNTING.md`, `docs/CRM.md`); 14 addon gates (MRP, Repair, Project, Asset, HRM, Payroll, Ecommerce, WooCommerce, HMS, Gym, AI, Field Force, ZATCA, Cheque) remain unverified and score only on real implementation |
