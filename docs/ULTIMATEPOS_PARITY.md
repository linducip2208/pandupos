...
| Transfer | Audited request/approve/ship/transit/partial-receive/receive/cancel state machine with preserved cost | D | D | D | D | D | D | D | PARTIAL | Multi-line request UI and requester/approver separation now have regressions; location/batch selectors and complete acceptance remain |
