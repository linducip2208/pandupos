...
| Serial tracking | Tenant receive/register UI, provenance/history, controlled lifecycle, and atomic checkout/return/void ledger linkage | D | D | P | P | D | D | D | PARTIAL | POS serial selector, transfer lifecycle integration, granular permission and end-to-end UI acceptance |
