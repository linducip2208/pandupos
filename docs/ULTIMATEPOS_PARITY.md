...
| Stock count/reconcile | Count snapshot-to-post and read-only reconcile CLI; requester cannot self-approve count | D | P | D | D | D | D | D | PARTIAL | Location/batch/serial count support, health result and complete operational acceptance |
