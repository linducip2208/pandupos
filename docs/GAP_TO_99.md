...
|---|---:|---|
| Core | 49 | Complete purchasing/AP UI/lifecycle; commercial sales/POS/register; reports/imports/dashboard |
...
5. Purchase request, multi-line PO/GRN/AP/return/statement/PDF/export. Safety is VERIFIED: `PurchasingSafetyTest`, `PurchaseApprovalTest` and `SupplierDocumentTest` prove PO stock timing, 30/40/30 receipts, idempotent retry, over-receipt/invoice/payment/return protection, approval and tenant isolation.
