...
|---|---:|---|
| Core | 36 | Batch/serial/reservation gates; complete purchasing/AP; commercial sales/POS/register; reports/imports/dashboard |
...
3. ~~Rack/bin transaction selectors.~~ VERIFIED: active tenant/warehouse-scoped selectors and stock trace cover batch receiving, PO goods receipt, reservation, transfer, adjustment and count. Reservation held-cart integration and cleanup scheduler remain.
