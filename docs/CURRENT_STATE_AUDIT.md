...
|---|---:|---|
| Core parity | 34% | Product, units, barcode, pricing, bundle, WAC, adjustment, stock count, reconciliation and transfer have independently verified gates; other advanced inventory, purchasing, sales/POS and reporting remain incomplete |
