...
|---|---:|---|
| Core parity | 39% | Product, units, barcode, pricing, bundle, rack/bin, reservation, WAC, adjustment, stock count, reconciliation and transfer have independently verified gates; batch/serial, purchasing, sales/POS and reporting remain incomplete |
