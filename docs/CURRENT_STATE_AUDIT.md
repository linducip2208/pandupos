...
|---|---:|---|
| Core parity | 48% | Advanced inventory controls now have a real tenant workspace; major purchase, sales-document and POS workflows remain |
...
| Test readiness | 55% | Costing matrix and inventory UI authorization/isolation are proven; many document/POS tests remain |
