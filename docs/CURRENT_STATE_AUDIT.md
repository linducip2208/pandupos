...
| Inventory ledger/WAC | Append-only ledger, strategy contract, WAC COGS/reversal/transfer/original-cost return and cache reconcile | Report only | Partial | Coarse | Checked | Costing matrix plus reconcile | Present | PARTIAL |
...
|---|---:|---|
| Core parity | 45% | Advanced inventory and WAC strategy are materially implemented; UI and major document workflows remain absent |
...
| Test readiness | 53% | Purchase/mixed-cost/sale/return/transfer/purchase-return costing matrix is proven; many document/POS tests remain |
