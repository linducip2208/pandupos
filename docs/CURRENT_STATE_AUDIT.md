...
|---|---:|---|
| Core parity | 43% | Product, units, barcode, pricing, bundle, rack/bin, reservation, serial lifecycle, WAC, adjustment, stock count, reconciliation and transfer have independently verified gates; batch, purchasing, sales/POS and reporting remain incomplete |
