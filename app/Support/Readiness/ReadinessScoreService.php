    ...
    public function dimensions(): array
    {
        return [
            ...
            'tests' => $this->dimension([
                ['Regression suite', 60, true, 'Latest local full suite: 532 tests / 2079 assertions (1 mysql-only backup test skips on sqlite); MySQL CI matrix runs the same suite green'],
