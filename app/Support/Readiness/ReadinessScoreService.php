    ...
    public function dimensions(): array
    {
        return [
            ...
            'future_addon_parity' => $this->dimension([
                ...
                ['Field Force', 4, false, 'Field tasks/GPS/visits not implemented'],
            ...
            'tests' => $this->dimension([
                ['Regression suite', 60, true, 'Latest local full suite: 574 tests / 2325 assertions (1 mysql-only backup test skips on sqlite); MySQL CI matrix runs the same suite green'],
