    ...
    public function dimensions(): array
    {
        return [
            ...
            'future_addon_parity' => $this->dimension([
                ...
                ['AI provider abstraction', 4, false, 'Multi-provider assistant abstraction not implemented'],
            ...
            'tests' => $this->dimension([
                ['Regression suite', 60, true, 'Latest local full suite: 567 tests / 2292 assertions (1 mysql-only backup test skips on sqlite); MySQL CI matrix runs the same suite green'],
