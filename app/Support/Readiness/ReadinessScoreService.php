    ...
    public function dimensions(): array
    {
        return [
            ...
            'future_addon_parity' => $this->dimension([
                ...
                ['CRM', 8, false, 'Leads/opportunities/pipeline not implemented'],
                ['Manufacturing / MRP', 8, false, 'BOM/work-order/production not implemented'],
                ['Repair', 6, false, 'Repair intake/orders/parts/labor not implemented'],
            ...
            'tests' => $this->dimension([
                ['Regression suite', 60, true, 'Latest local full suite: 483 tests / 1797 assertions (1 mysql-only backup test skips on sqlite); MySQL CI matrix runs the same suite green'],
