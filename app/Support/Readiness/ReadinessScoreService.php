    ...
    public function dimensions(): array
    {
        return [
            'core' => $this->dimension([
                ...
                ['Batch, expiry and FEFO end-to-end', 4, false, 'Receive, provenance, selector, FEFO, expired prevention, audit and tests'],
                ['Serial lifecycle end-to-end', 4, false, 'Receive, reserve, sell, return, transfer, damage, history and tests'],
                ['Rack/bin transaction integration', 2, false, 'Location lifecycle, stock visibility and current transaction selectors'],
                ['Reservation lifecycle integration', 3, false, 'Sales-order reserve/release/consume/partial/expiry, scheduler and tests'],
                ['Transfer workflow and segregation', 2, false, 'Multi-line UX, requester/approver separation, state machine and tests'],
                ['Adjustment and stock-count governance', 2, false, 'Multi-line draft/review/approve/post, immutable posting and tests'],
                ['Read-only reconciliation operations', 1, false, 'Safe reconcile command, health visibility, alert and regression proof'],
                ['Purchasing/AP UI and lifecycle', 12, false, 'Current PO, approval, receipt, invoice, payment and return end-to-end'],
                ['Purchasing transaction safety', 6, false, 'Duplicate receipt, partial receipt, return and overpayment regression evidence'],
                ['Sales document lifecycle', 8, false, 'Current quotation, proforma, order, delivery, invoice and payment flow'],
                ['POS and register current workflow', 10, false, 'Current POS checkout, register and receipt workflow evidence'],
                ['Return, void and payment correctness', 4, false, 'Controlled reversal, over-return and duplicate-payment/void proof'],
                ['Existing reports and exports', 6, false, 'Current report totals, filters, tenant/RBAC/export consistency'],
                ['Current dashboard and operational visibility', 4, false, 'Permission-safe tenant metrics and no-N+1 evidence'],
            ]),
            'saas' => $this->dimension([
