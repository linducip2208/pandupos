    ...
    public function dimensions(): array
    {
        return [
            ...
            'future_addon_parity' => $this->dimension([
                ...
                ['ZATCA / tax compliance', 4, false, 'E-invoice QR/XML/signing not implemented'],
                ['Cheque', 4, false, 'Cheque receipt/deposit/clearance/bounce not implemented'],
            ]),
            'tests' => $this->dimension([
                ['Regression suite', 60, true, 'Latest local full suite: 581 tests / 2365 assertions (1 mysql-only backup test skips on sqlite); MySQL CI matrix runs the same suite green'],
