    ...
    public function dimensions(): array
    {
        return [
            ...
            'future_addon_parity' => $this->dimension([
                ...
                ['Ecommerce', 8, false, 'Online catalog/cart/checkout not implemented'],
            ...
            'tests' => $this->dimension([
                ['Regression suite', 60, true, 'Latest local full suite: 541 tests / 2131 assertions (1 mysql-only backup test skips on sqlite); MySQL CI matrix runs the same suite green'],
